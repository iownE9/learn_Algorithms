...
public class Merge {
    ...
    private static void merge(Comparable[] a, Integer[] index, int[] aux, int lo, int mid, int hi) {
     ...
     */
    public static Integer[] indexSort(Comparable[] a) {
        int n = a.length;
    ...
    private static void sort(Comparable[] a, Integer[] index, int[] aux, int lo, int hi) {
        if (hi <= lo) return;
        int mid = lo + (hi - lo) / 2;
    ...
    public static void main(String[] args) {
        ...
        Integer[] index = Merge.indexSort(a);
        show(index);
    }
